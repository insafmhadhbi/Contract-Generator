...
import { BGS, PRIOTITYSTYELS, TASK_TYPE, formatDate } from "./../pages/utils/index";
...
const TaskCard = ({ task, handleOnDrag }) => {
      ...
      >
        <div className='w-full flex justify-between'>
          ...
          >
            ...
            <span className='uppercase'>{t(`taskCard:${task?.priority}Priority`)}</span>
          </div>
        ...
        {task?.subTasks?.length > 0 ? (
          ...
          <div className='py-4 border-t border-gray-200'>
            <span className='text-gray-500'>{t("taskCard:noSubTask")}</span>
          </div>
        )}
        <div className='w-full pb-2'>
          ...
          >
            ...
            <span>{t("taskCard:addSubTask")}</span>
          </button>
        </div>
      </div>
