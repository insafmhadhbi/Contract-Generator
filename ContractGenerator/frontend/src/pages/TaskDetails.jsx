...
import { PRIOTITYSTYELS, TASK_TYPE, getInitials } from "../../src/pages/utils/index";
...
const TABS = [
  { title: "taskDetails:taskDetail", icon: <FaTasks /> },
  { title: "taskDetails:commentsTimeline", icon: <RxActivityLog /> },
];
...
const TaskDetails = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      ...
      <Tabs tabs={TABS.map(tab => ({ title: t(tab.title), icon: tab.icon }))} setSelected={setSelected}>
        {selected === 0 ? (
          <>
              ...
              <div className='w-full md:w-1/2 space-y-8'>
                <div className='flex items-center gap-5'>
                  <div className={clsx(
                    ...
                    <span className='uppercase'>{t(`taskDetails:${task?.priority} Priority`)}</span>
                  </div>
                ...
                <p className='text-gray-500'>
                  {t("taskDetails:createdAt")}: {new Date(task?.date).toDateString()}
                </p>

                <div className='flex items-center gap-8 p-4 border-y border-gray-200'>
                  <div className='space-x-2'>
                    <span className='font-semibold'>{t("taskDetails:subTasks")}:</span>
      ...
      <div className='flex space-x-4'>
        ...
        <div className='flex flex-col gap-y-1 mb-8'>
          ...
          <div className='text-gray-500 space-y-2'>
            <span className='capitalize'>{t(`taskDetails:${item?.type}`)}</span>
  ...
  return (
    <div className='w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto'>
      <div className='w-full md:w-1/2'>
        <h4 className='text-gray-600 font-semibold text-lg mb-5'>{t("taskDetails:activities")}</h4>
